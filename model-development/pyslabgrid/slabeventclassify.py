...
def within_interfacezone(evlon, evlat):
    ...
    hik_finterp = np.load('../subduction-model/finterp/hik_finterp.npy', allow_pickle=True)[()]
    ...
    puy_finterp = np.load('../subduction-model/finterp/puy_finterp.npy', allow_pickle=True)[()]
...
def is_slabevent(evlon, evlat, evdep, fixed_parameters = None):
    ...
    if szone is None:
        ...
        if szone =='hik':
            dep_finterp = np.load('../subduction-model/finterp/hik_finterp_lowerbounds.npy', allow_pickle=True)[()]
        else:
            dep_finterp = np.load('../subduction-model/finterp/puy_finterp_lowerbounds.npy', allow_pickle=True)[()]
